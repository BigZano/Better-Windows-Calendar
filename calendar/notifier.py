...
class Notifier(ABC):
    ...
    @abstractmethod
    def notify(self, title: str, message: str, event_data: Dict[str, Any] = None) -> bool:
...
class WindowsToastNotifier(Notifier):
    ...
    try:
        ...
        notifier = self.ToastNotificationManager.create_toast_notifier("Fuck you MicroSlop")
        notifier.show(toast)
